...
public class MakeANote {
    ...
    private static final String[] displayMenu = {"Display Options", "Display all Notes",
            "Display Note by Number", "Display Notes by Name","Sort By Name","Sort By Number","Sort By Szie","Return to previous menu"};
                    ...
                    do {
                        ...
                        switch (subchoice) {
                            ...
                            case 1:
                                ...
                                //Creating Memo using Factory Method Pattern
                                // Creating simple printType object
                                Note nw = NoteCollection.createNote("Memo",name,body,from,to,"Simple");
                                System.out.println("Memo Created ");
                                // it to the Notecollection
                                noteCollection.add(nw);
                                nw.display();
                                break;
                            ...
                            case 2:
                                ...
                                Note tm = NoteCollection.createNote("TimedMemo",name,body,to, from,"Fancy");
                            ...
                            case 3:
                                ...
                                Note ptm = NoteCollection.createNote("PoliteTimedMemo",name,body,to, from,"Really");
